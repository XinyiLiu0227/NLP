...
class Embedding(nn.Module):
    ...
    def __init__(self, word_vectors,char_vectors, hidden_size, drop_prob):# add char_vec
        ...
        self.char_proj = nn.Linear(16*char_vectors.size(1), hidden_size//2, bias=False)
    ...
    def forward(self, xw, xc):
        ...
        #
        # return emb
        char_emb = self.char_embed(xc)
        word_emb = self.word_embed(xw)  # (batch_size, seq_len, embed_size)
        char_emb = char_emb.view((char_emb.size(0), char_emb.size(1), -1))
...
class BiDAFAttention(nn.Module):
    ...
    def get_similarity_matrix(self, c, q):
        ...
        # print("c: ", c.size(), " c_weight: ", self.c_weight.size())
